...
from nd_utility.data.storage.storage import Storage  # base class (assumed)
...
def _build_file(path: str, **kwargs: Any) -> Storage:
    ...
    """
    from nd_utility.data.storage.type import File
...
def _build_dir(path: str, **kwargs: Any) -> Storage:
    ...
    """
    from nd_utility.data.storage.type import Dir
...
def _build_db(conn: str, **kwargs: Any) -> Storage:
    ...
    """
    from nd_utility.data.storage.type import Db
