...
def _build_file(path: str, **kwargs: Any) -> Storage:
    """
    Example:
        get_storage(StaticFactory.FILE, "/tmp/data_set.bin", mode="rw")
    """
...
def _build_dir(path: str, **kwargs: Any) -> Storage:
    """
    Example:
        get_storage("dir", "/var/data_set", create_if_missing=True)
    """
...
def get_storage(kind: int | str | StaticFactory, /, *args: Any, **kwargs: Any) -> Storage:
    ...
    Examples:
        ...
        d = get_storage("dir", "/data_set", create_if_missing=True)
