...
from utilityx.data.type.sliced_values.values_slices import ValuesSlices


class MultiValue(Decorator):
    """
    A kind of source full of  values such as a sliced_values doc yaml file
    """
    ...
    def get_ram_values_by_slice(self, slc: slice) -> list[str]:
